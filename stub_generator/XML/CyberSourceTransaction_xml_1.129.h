...
/// Vector of std::string of length 0..7.
    std::vector<std::string            > line                           0:7;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/// Vector of std::string of length 0..100.
    std::vector<std::string            > name                           0:100;
/// Vector of std::string of length 0..100.
    std::vector<std::string            > address                        0:100;
/// Vector of std::string of length 0..100.
    std::vector<std::string            > program                        0:100;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/// Vector of std::string of length 0..1000.
    std::vector<std::string            > missingField                   0:1000;
/// Vector of std::string of length 0..1000.
    std::vector<std::string            > invalidField                   0:1000;
