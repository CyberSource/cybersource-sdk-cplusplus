/* soapINVPTransactionProcessorService.h
...
#ifndef soapINVPTransactionProcessorService_H
#define soapINVPTransactionProcessorService_H
#include "soapH.h"

    class SOAP_CMAC INVPTransactionProcessorService {
      public:
        ...
        INVPTransactionProcessorService();
        /// Copy constructor
        INVPTransactionProcessorService(const INVPTransactionProcessorService&);
        /// Construct service given a shared managing context
        INVPTransactionProcessorService(struct soap*);
        /// Constructor taking input+output mode flags for the new managing context
        INVPTransactionProcessorService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        INVPTransactionProcessorService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context, when the context was allocated by the constructor
        virtual ~INVPTransactionProcessorService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void INVPTransactionProcessorService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual INVPTransactionProcessorService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        INVPTransactionProcessorService& operator=(const INVPTransactionProcessorService&);
        ...
        //
        /// Web service operation 'runTransaction' implementation, should return SOAP_OK or error code
        virtual int runTransaction(const std::string& ns2__nvpRequest, std::string &ns2__nvpReply) SOAP_PURE_VIRTUAL;
    };
#endif
