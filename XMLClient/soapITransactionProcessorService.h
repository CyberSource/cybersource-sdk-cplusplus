/* soapITransactionProcessorService.h
...
#ifndef soapITransactionProcessorService_H
#define soapITransactionProcessorService_H
#include "soapH.h"

    class SOAP_CMAC ITransactionProcessorService {
      public:
        ...
        ITransactionProcessorService();
        /// Copy constructor
        ITransactionProcessorService(const ITransactionProcessorService&);
        /// Construct service given a shared managing context
        ITransactionProcessorService(struct soap*);
        /// Constructor taking input+output mode flags for the new managing context
        ITransactionProcessorService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        ITransactionProcessorService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context, when the context was allocated by the constructor
        virtual ~ITransactionProcessorService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void ITransactionProcessorService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual ITransactionProcessorService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        ITransactionProcessorService& operator=(const ITransactionProcessorService&);
        ...
        virtual int runTransaction(ns2__RequestMessage *ns2__requestMessage, ns2__ReplyMessage &ns2__replyMessage) SOAP_PURE_VIRTUAL;
    };
#endif
